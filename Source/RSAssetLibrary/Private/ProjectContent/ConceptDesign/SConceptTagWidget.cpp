...
void SConceptTagWidget::ReloadSelectedTags()
{
    FString ThisTag = GEditor->GetEditorSubsystem<UUSMSubsystem>()->GetCurrentConceptTagname();
...
void SConceptTagWidget::AddTagToSelected(const FString& TagName)
{
    ...
    GEditor->GetEditorSubsystem<UUSMSubsystem>()->SetCurrentConceptTagname(TagName);
